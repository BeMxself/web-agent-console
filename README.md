...
<img src="docs/readme/mobile-login.png" alt="共享密码输入界面" width="280" />

### 项目 / 会话选择

<img src="docs/readme/mobile-sessions.png" alt="项目和会话选择界面" width="280" />

### 输入图片

<img src="docs/readme/mobile-image-input.png" alt="移动端输入图片界面" width="280" />

### 添加文件

<img src="docs/readme/mobile-file-attachments.png" alt="移动端添加文件界面" width="280" />

### 计划任务

<img src="docs/readme/mobile-task-plan.png" alt="移动端计划任务界面" width="280" />
